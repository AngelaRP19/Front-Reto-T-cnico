...
const VARIANTS = {
  ...
  oauth:
    "flex-1 border-none bg-snd-bg text-text py-3 text-[0.9375rem] rounded-full font-bold [transition:background-color_0.3s_ease,color_0.4s_ease] hover:bg-hover hover:text-white",
  link:
