function Card(props) {
  return (
    <div className="group bg-card-bg text-text rounded-[1.25rem] shadow-[0_6px_18px_rgba(0,0,0,0.6)] overflow-hidden w-full max-w-[21.875rem] md:w-[18.75rem] md:max-w-none flex flex-col justify-between [transition:background-color_0.4s_ease,color_0.4s_ease,transform_0.3s_ease] hover:-translate-y-[0.375rem]">
