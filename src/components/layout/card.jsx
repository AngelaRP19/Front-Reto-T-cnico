function Card(props) {
  return (
    <div className="group bg-card-bg text-text rounded-[1.25rem] shadow-[0_0.375rem_1.125rem_rgba(0,0,0,0.6)] overflow-hidden w-full h-full max-w-[21.875rem] flex flex-col justify-between [transition:background-color_0.4s_ease,color_0.4s_ease,transform_0.3s_ease] hover:-translate-y-[0.375rem]">
