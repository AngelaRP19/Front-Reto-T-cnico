...
function Navbar() {
  ...
  return (
    ...
    >
      ...
      {/* ==================================================
          CONTROLES DE CELULAR Y TABLET

          Aquí solamente aparecen:

          - Avatar si el usuario está logueado
          - Botón hamburguesa

          IMPORTANTE:
          El avatar NO vuelve a aparecer dentro del menú.
      ================================================== */}
        ...
        {user && (
          ...
          <div className="relative">
            ...
            {/* ==================================================
                ...
                Este menú aparece al tocar la C.
