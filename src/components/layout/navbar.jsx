      ...
      {showUserMenu && (
        <div className="absolute right-0 top-full mt-2 w-64 bg-card-bg text-text rounded-xl shadow-lg p-4 z-50 transition-colors duration-300">
          ...
          <Link
            ...
            className="block w-full mt-2 text-sm font-bold text-main hover:text-hover transition-colors text-left no-underline"
          >
            Mi Perfil
          </Link>
          <button
            onClick={handleLogout}
            className="w-full mt-2 text-sm font-bold text-text opacity-70 hover:opacity-100 transition-opacity text-left cursor-pointer"
          >
            Cerrar sesión
          </button>
        </div>
